...
In addition to manually creating new watchlists, the TTG-SIM Trader also enables traders to import watchlists from CSV Files. This can be done by clicking **Load from file**.
